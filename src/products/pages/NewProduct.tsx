...
export const NewProduct = () => {
  ...
  const { control, handleSubmit, watch } = useForm<FormInputs>({
    defaultValues: {
      ...
      image: 'https://click.gt/cdn/shop/files/TKL-large.jpg?v=1724206856',
    }
  });
      ...
      <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
        <div className="flex justify-around items-center">
          <div className="flex-col w-[500px]">
            ...
            <br />
            <Button isDisabled={productMutation.isPending} type="submit" className="mt-2"
              color="primary">{productMutation.isPending ? 'Cargando...' : 'Crear producto'}</Button>
          </div>
